...
describe QuotesController do
  ...
  let(:valid_attributes) { { "price" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved quote as @quote" do
        ...
        post :create, {:quote => { "price" => "invalid value" }}, valid_session
        assigns(:quote).should be_a_new(Quote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quote" do
        ...
        Quote.any_instance.should_receive(:update_attributes).with({ "price" => "1.5" })
        put :update, {:id => quote.to_param, :quote => { "price" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the quote as @quote" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Quote.any_instance.stub(:save).and_return(false)
        put :update, {:id => quote.to_param, :quote => { "price" => "invalid value" }}, valid_session
        assigns(:quote).should eq(quote)
      end
